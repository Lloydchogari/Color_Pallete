      ...
      <div className="absolute inset-0 overflow-y-auto">
        <div className="h-full w-full flex items-center justify-center p-4">
          {!showUploader ? (
            ...
            <div className="overflow-y-hidden max-h-[100vh] backdrop-blur-lg bg-white/10 border border-white/30 shadow-2xl rounded-2xl p-6 md:p-8 w-full max-w-xl text-center">
